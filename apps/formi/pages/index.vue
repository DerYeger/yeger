...
const { appLink, featuresLink } = useLinks()
</script>
...
<template>
  ...
  >
    <div class="md:w-50% flex flex-col gap-10">
      ...
      <HeroProse>
        Formi is a web-application for model checking first-order-logic formulas. Interactive graphs
        visualize models that are defined using an intuitive YAML-based editor.
      </HeroProse>
      <HeroProse>
        Real-time validation of formula and model inputs results in a near-instantaneous feedback
        cycle. Formulas and evaluation results are displayed as trees, presenting insight into the
        formula AST and model checking results.
      </HeroProse>
