  ...
  <div id="app">
    ...
    <main ref="scrollContainer" :class="{ 'scroll-container': useScrollContainer }">
      <DemoTools
        ...
        :gap="gap"
        :rtl="rtl"
        :use-scroll-container="useScrollContainer"
        :min-columns="minColumns"
        :max-columns="maxColumns"
        @update:column-width="(value) => (columnWidth = value)"
        @update:gap="(value) => (gap = value)"
        @update:rtl="(value) => (rtl = value)"
        @update:use-scroll-container="(value) => (useScrollContainer = value)"
        @update:min-columns="(value) => (minColumns = value)"
        @update:max-columns="(value) => (maxColumns = value)"
      ...
      <MasonryWall
        ...
        :gap="gap"
        :rtl="rtl"
        :scroll-container="useScrollContainer ? scrollContainer : null"
        :min-columns="minColumns"
        :max-columns="maxColumns"
      >
