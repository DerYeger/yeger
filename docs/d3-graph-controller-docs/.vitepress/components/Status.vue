...
const badges: Badge[] = [
  ...
  {
    href: `https://app.codecov.io/gh/${repo}/tree/main/packages/d3-graph-controller`,
    alt: 'Codecov',
    src: `https://codecov.io/gh/${repo}/branch/main/graph/badge.svg?token=DjcvNlg4hd&flag=d3-graph-controller`,
  },
  {
